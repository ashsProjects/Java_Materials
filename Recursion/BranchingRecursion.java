 ...
 *
 */
public class BranchingRecursion {
    ...
    public static int mult(int j, int k) {
        if (k == 0) {
            ...
            return mult(Math.abs(j), Math.abs(k));
        } else {
            return j + mult(j, k - 1);
        }
    }
    ...
    public static boolean isPalindrome(String word) {
        if (word.length() == 0) {
            ...
            return isPalindrome(word.toLowerCase(), 0, word.length() - 1);
        }
    }

    public static boolean isPalindrome(String word, int a, int b) {
        if (a == b) {
            return true;
        } else if (word.charAt(a) != word.charAt(b)) {
            return false;
        } else if (a < b + 1) {
            return isPalindrome(word, a + 1, b - 1);
        }
        return true;
    }
    ...
    public static int longestWordLength(String words) {
        return longestWordLength(words.replaceAll("[^a-zA-Z\\s]", "").split(" "), 0, "");

    }

    public static int longestWordLength(String[] words, int i, String longest) {
        if (i >= words.length) {
        ...
        return longestWordLength(words, i + 1, longest);
    }
    ...
    public static String dedupeChars(String word, int i) {
        ...
        if (word.toLowerCase().charAt(i) == (word.toLowerCase().charAt(i + 1))) {
            ...
            if (word.length() > i + 1 && word.toLowerCase().charAt(i) == (word.toLowerCase().charAt(i + 1))) {
                word = sb.deleteCharAt(i + 1).toString();
            }
            if (word.length() > i + 2 && word.toLowerCase().charAt(i) == (word.toLowerCase().charAt(i + 1))) {
                word = sb.deleteCharAt(i + 1).toString();
            }
            if (word.length() > i + 3 && word.toLowerCase().charAt(i) == (word.toLowerCase().charAt(i + 1))) {
                word = sb.deleteCharAt(i + 1).toString();
            }
        }
    ...
    public static void main(String[] args) {
        ...
        // Note: in zyBooks the main in Main.java will run instead, and it is all of the
        // below statements.
        ...
        System.out.printf("mult(-7, -8) should be 16 -> %d\n", mult(-7, -8));
